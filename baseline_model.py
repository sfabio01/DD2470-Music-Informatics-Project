...
class CNNDecoder(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.ConvTranspose2d(1, 32, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
        self.conv2 = nn.ConvTranspose2d(32, 16, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
...
class Song2Vec(nn.Module):
    def __init__(self):
        ...
        self.fc_dec = nn.Linear(in_features=1024, out_features=256)
